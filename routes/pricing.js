...
router.post('/update', (req, res, next) => {
    connection.query("UPDATE pricing SET flight_id=?, seating_type_id=?, cost=?, baggage_limit=? WHERE id = ?", [req.body.flight, req.body.seating_type, req.body.cost, req.body.baggage, req.body.id], (err, fields, data) => {
        if(!err)
